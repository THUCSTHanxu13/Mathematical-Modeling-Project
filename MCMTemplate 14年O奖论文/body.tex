...
\begin{figure}[H]
    \centering
    \includegraphics[width=4in,height=2.5in]{./picture/Change-to-the-left-lane.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=4.00in,height=2.50in]{./picture/Change-back-to-the-right-lane.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=4.00in,height=2.80in]{./picture/Clarification.jpg}
...
\begin{figure}
    \centering
    \centerline{\includegraphics[width=6.5in]{./picture/Chart.jpg}}
...
\begin{figure}
    \centering
    \centerline{\includegraphics[width=4in,height=2.5in]{./picture/ramps.jpg}}
