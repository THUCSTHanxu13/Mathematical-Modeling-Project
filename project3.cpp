...
float work() {
	...
	return res[trainTimes - 1]/(float)(repeatTimes);
	// for (int i = 0; i < repeatTimes ; i++)
	// 	if (fabs(res[trainTimes -1] - res[i]) /(float)(repeatTimes)<= 1e-5) return i;
